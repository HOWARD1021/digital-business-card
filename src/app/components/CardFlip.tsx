...
const defaultProfile: ProfileInfo = {
  ...
  qrCodeUrl: "https://your-profile-link"
};
          ...
          >
            ...
            <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-white rounded-3xl backface-hidden">
              <div className="text-center">
                ...
                <div className="text-lg font-bold">Business Card Front</div>
                <div className="text-sm text-gray-500 mt-2">點擊卡片翻到背面</div>
              </div>
            </div>
            {/* Back Side */}
                  ...
                  <>
                    ...
                    <div className="w-full space-y-3 mb-8">
                      <a 
                        ...
                        className="w-full py-3 bg-white/90 hover:bg-white rounded-md font-medium 
