    ...
    <footer className="bg-[#f5ede1] text-[#3d3228] border-t border-[#dfceba] py-8 sm:py-10 font-serif">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Right: Circular Social Media Icons matching mockup */}
          <div className="flex items-center gap-3">
            {/* Facebook SVG */}
            <a
              ...
              className="w-8 h-8 rounded-full bg-[#25211e] hover:bg-[#a83d2a] text-white flex items-center justify-center transition-colors shadow-2xs"
              aria-label="Facebook"
            >
